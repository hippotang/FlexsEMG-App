...
//                intent.putExtra(EXTRA_DATA, new String(data) + "\n" + stringBuilder.toString());
    ...
    // set UUID as read or notify
    public void setDescriptorValue(BluetoothGattDescriptor descriptor, byte[] value) {
        // First set notification for Gatt object
        if (!mBluetoothGatt.setCharacteristicNotification(descriptor.getCharacteristic(), true)) {
            Log.e(TAG, String.format("ERROR: setCharacteristicNotification failed for descriptor: %s", descriptor.getUuid()));
        }
        // Then write to descriptor
        descriptor.setValue(value);
        // write descriptor to GATT then error check
        boolean result;
    ...
    /*
    Resources for Service Interface
     */
    ...
    public IBinder onBind(Intent intent) {
        Log.i(TAG, "BLE service onBind called");
        return mBinder;
    }
